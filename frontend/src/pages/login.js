  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#1A1A1A]">
      <div className="p-6 bg-[#252526] rounded-lg shadow-lg w-full max-w-md">
        ...
        <h1 className="text-2xl font-bold text-white mb-6 text-center">Log in to WhisperFeed</h1>
        ...
        <form onSubmit={handleLogin}>
          ...
          <input
            ...
            className="w-full p-3 mb-6 bg-[#333] text-white rounded-lg border border-[#555] focus:outline-none focus:border-[#1DA1F2] placeholder-gray-500"
          />
          <button
            type="submit"
        ...
        <div className="mt-6 flex justify-between text-sm">
          <Link href="/signup" className="text-[#1DA1F2] hover:underline">
            Sign Up
          </Link>
